...
// dark()
// 上面注释掉的代码流星朝 右上 飞，下面代码改为了朝 右下 落
function dark() {
    window.requestAnimationFrame = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame;
  
    var n, e, i, h, t = 0.05, s = document.getElementById("universe"), o = !0, a = "180,184,240", r = "226,225,142", d = "226,225,224", c = [];
    ...
    function y() {
      ...
      this.fadeOut = function () {
        this.fadingOut && (this.fadingOut = !(this.opacity < 0), this.opacity -= this.do / 2, (this.x > n || this.y > e) && (this.fadingOut = !1, this.reset()));
      },
      this.draw = function () {
      ...
      this.move = function () {
        this.x += this.dx, this.y += this.dy, !1 === this.fadingOut && this.reset(), (this.x > n - n / 4 || this.y > e) && (this.fadingOut = !0);
      }, setTimeout(function () {
        o = !1;
      }, 50);
    }
